...
En este caso el Eout es `r I(Eout*100)`%. La transformación parece que ha servido puesto fuera de la muestra el clasificador se muestra bastante fiable: ni un 1% de errores.
