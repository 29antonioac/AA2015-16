...
El número de árboles óptimo es `r I(randomFor.optimalntree$ntree)`. El error de test usando 500 es `r I(randomFor.error)`, y el error de test usando el óptimo es `r I(randomFor.optimalntree.error)`.

```{r echo = FALSE}
msg <- "En este caso usar el óptimo no nos ha ofrecido mejora sobre el error de test."
